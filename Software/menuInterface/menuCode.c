/* This code is a sample for creating a menu interface on arduino with 3 buttons and a LCD display. */

/* 
Tutorial Website: http://eeenthusiast.com/arduino-lcd-tutorial-display-menu-system-scrolling-menu-changeable-variables-projects/
*/
